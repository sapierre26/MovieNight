...
import MovieLibraryItem from "./services/movie-library-grid-item-svc";
...
// app.get("/PlaylistItem/:songName", (req: Request, res: Response) => {
...
// app.get("/MoviesOutNowItem/:movieName", (req: Request, res: Response) => {
...
// app.get("/TheatersSubItem/:theaterName", (req: Request, res: Response) => {
...
// app.get("/MovieLibraryItem/:movieName", (req: Request, res: Response) => {
//   const { movieName } = req.params;
...
// app.get("/TheatersListItem/:theaterName", (req: Request, res: Response) => {
//   const { theaterName } = req.params;
...
// app.get("/TheaterSubItem/:theaterName", (req: Request, res: Response) => {
//   const { theaterName } = req.params;
...
// app.get("/ArtifactsItem/:artifactName", (req: Request, res: Response) => {
